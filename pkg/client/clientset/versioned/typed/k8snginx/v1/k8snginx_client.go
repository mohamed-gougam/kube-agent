...
import (
	...
	"github.com/mohamed-gougam/kube-agent/pkg/client/clientset/versioned/scheme"
...
func (c *K8sV1Client) TCPServers(namespace string) TCPServerInterface {
	return newTCPServers(c, namespace)
}
